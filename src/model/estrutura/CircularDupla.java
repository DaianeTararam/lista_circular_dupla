...
public class CircularDupla<T>{
	...
	//getLast		Retorna um no, o ultimo adicionado;
	...
	public No<T> getLast()throws IllegalArgumentException{
		if(this.ultimo_elemento == null) throw new IllegalArgumentException("Não existe item na lista.");
	...
	public int total(){
		...
		do{
			total_elementos++;
			buffer = buffer = buffer.getProximo();
